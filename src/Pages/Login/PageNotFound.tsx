...
const PageNotFound = () => {
	...
	return (
		<div className='pagenotfound'>
			<svg className='svg' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="380px" height="500px" viewBox="0 0 837 1045" version="1.1">
			...
			<div className="message-box">
				...
				<div className="buttons-con">
					<div className="action-link-wrap">
						<button className="btn-white" onClick={handleBack}>Go Back</button>
